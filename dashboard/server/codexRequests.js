...
export const SETUP_METADATA_EVENTS = ["codex.conversation_starts", "codex.startup_phase", "codex.user_prompt"];

export function isSetupMetadataEvent(attributes) {
  return SETUP_METADATA_EVENTS.includes(attributes["event.name"])
