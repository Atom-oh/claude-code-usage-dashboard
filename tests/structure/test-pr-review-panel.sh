...
EOF2
    ...
    assert_file_exists "failed preflight leaves a diagnostic flag" "$T_STUB/work/kiro-preflight.flag"
    assert_file_exists "failed preflight forces coverage failure" "$T_STUB/work/coverage-severe.flag"
